...
(function () {
  ...
  const DICT = {
    ...
    'teach.hardwareRecord': { zh: '推动真机示教', en: 'Push real arm' },
    'teach.hardwareMode': { zh: '真机示教记录方式', en: 'Hardware teach recording mode' },
    ...
    'sim.hardwareRecording': { zh: '真机原始采样中：{n} 点 / {sec} 秒', en: 'Raw hardware recording: {n} pts / {sec} s' },
    'sim.hardwareRecorded': { zh: '真机原始示教 {n} 点 / {sec} 秒', en: 'Raw hardware teach {n} pts / {sec} s' },
    'sim.hardwareEndpointRecording': { zh: '真机最终位置采集中：拖到目标后结束示教', en: 'Capturing final hardware position: stop teaching at the target' },
    'sim.hardwareEndpointRecorded': { zh: '已记录真机最终位置，回放时 3 秒到位', en: 'Final hardware position recorded; replay moves there in 3 s' },
    'sim.stopRecord': { zh: '停止录制', en: 'Stop recording' },
    'sim.stopHardwareRecord': { zh: '结束真机示教', en: 'Stop arm teaching' },
