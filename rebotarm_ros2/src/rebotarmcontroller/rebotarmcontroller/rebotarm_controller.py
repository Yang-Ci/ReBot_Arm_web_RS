...
class reBotArmController(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("hardware_feedback_poll_rate", 100.0)
        ...
        hardware_feedback_poll_rate = float(
            self.get_parameter("hardware_feedback_poll_rate").value
        )
